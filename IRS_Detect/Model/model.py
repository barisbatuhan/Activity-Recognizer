...
class Act_Model:
    ...
    def load_model(self):
        self.model.load_weights('./Model/stored_models/model.h5')
        self.model.compile(loss=self.losses, loss_weights=self.lossWeights,  optimizer=Adam(
            self.lr), metrics=["accuracy", "accuracy", "accuracy", "accuracy"])
